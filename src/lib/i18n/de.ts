...
export const de: Translations = {
  ...
  scoring_mode_11_hard: "11 Pkt · Harter Cap (kein Ext.)",
  scoring_mode_11_ext:  "11 Pkt · Verlängerung bis 20",
  scoring_mode_15_hard: "15 Pkt · Harter Cap (kein Ext.)",
  scoring_mode_15_ext:  "15 Pkt · Verlängerung bis 25",
  scoring_mode_21_ext:  "21 Pkt · Verlängerung bis 30",
  scoring_sets_to_win:  "Gewinnsätze",
  ko_modal_title: "KO-Phase starten",
  ko_modal_group_phase_scoring: "Gruppenphase Scoring",
  ko_modal_use_different: "Andere Einstellungen für KO-Runden verwenden",
  ko_modal_ko_scoring: "KO-Runden Scoring",
  ...
  tournament_min_rest_unit: "Minuten",
  tournament_enable_third_place: "Spiel um Platz 3 austragen",
  tournament_enable_third_place_hint: "Die beiden Halbfinal-Verlierer spielen ein zusaetzliches Match um Platz 3.",
  bracket_third_place: "Spiel um Platz 3",
  bracket_third_place_short: "Platz 3",
  group_progress_title: "Fortschritt pro Gruppe",
  group_progress_label: "Gruppe {n}",
  group_progress_behind_tooltip: "Gruppe liegt hinter dem Durchschnitt zurueck — Court-Queue priorisiert sie automatisch",
  groups_matches_title: "Partien",
  groups_matches_count: "{count} Spiele",
  groups_match_in_progress: "Laeuft",
  groups_match_not_played: "noch nicht gespielt",
  rest_warning_title: "Mindest-Ruhezeit nicht eingehalten",
  rest_warning_body: "Folgende Spieler haben noch keine ausreichende Pause seit ihrem letzten Match:",
  rest_warning_player_row: "{player} — noch {minutes} Min. Pause",
  rest_warning_confirm: "Trotzdem zuweisen",
  rest_warning_cancel: "Abbrechen",
  tournament_player_resting_tooltip: "Noch {minutes} Min. Pause",
  seed_badge_short: "S{n}",
  seed_badge_tooltip: "Setzplatz {n}",
  ...
  // Live publishing
  settings_live_publish_section: "Live-Veroeffentlichung (WordPress)",
  settings_live_publish_help: "Schickt Spielplan, Ergebnisse und Tabelle live an deine WordPress-Seite. Voraussetzung: das BOSS Live Results Plugin ist auf deiner WP-Site installiert. Hier nur Endpunkt und Secret hinterlegen \u2014 die eigentliche Live-Veroeffentlichung wird pro Turnier in der Detail-Ansicht aktiviert (standardmaessig aus). Es werden nur Vor-/Nachname und Verein uebertragen \u2014 keine Geburtsdaten, keine Bezahlinfos.",
  settings_live_publish_url: "Endpunkt-URL",
  settings_live_publish_url_placeholder: "https://deine-seite.de/wp-json/boss/v1/push",
  settings_live_publish_secret: "Shared Secret",
  settings_live_publish_secret_placeholder: "Selber String wie im WP-Plugin",
  settings_live_publish_test: "Verbindung testen",
  settings_live_publish_test_ok: "Verbindung OK",
  settings_live_publish_test_fail: "Verbindung fehlgeschlagen: {error}",
  settings_live_publish_last_push: "Letzter Push",
  settings_live_publish_save: "Speichern",
  settings_live_publish_saved: "Gespeichert",
  settings_live_publish_status_running: "Verbindung konfiguriert \u2014 pusht jedes Turnier mit aktivierter Live-Veroeffentlichung event-basiert + 60s Heartbeat.",
  settings_live_publish_no_tournaments: "Aktuell ist kein Turnier zur Live-Veroeffentlichung aktiviert.",
  tournament_live_publish_enable: "Live aktivieren",
  tournament_live_publish_active: "Live aktiv",
  tournament_live_publish_enabled: "Live-Veroeffentlichung aktiviert",
  tournament_live_publish_no_config: "Bitte zuerst in den Einstellungen Endpunkt und Secret eintragen.",
  tournament_live_publish_id_hint: "Turnier-ID {id} \u2014 fuer den WordPress-Shortcode, z.B. [boss_matches id=\"{id}\"]",
  tournament_live_publish_disabled_draft: "Erst nach Turnier-Start",
  tournament_live_publish_pause: "Pause",
  tournament_live_publish_resume: "Fortsetzen",
  tournament_live_publish_paused_label: "Live pausiert",
  tournament_live_publish_push_now: "Jetzt pushen",
  tournament_live_publish_pushed_now: "Push ausgeloest",
  tournament_live_status_pushed_ago: "Push vor {time}",
  tournament_live_status_error_ago: "Fehler vor {time}",
  tournament_live_status_backoff: "Wartet (Verbindung gestoert)",
  tournament_live_status_never_pushed: "Noch kein Push",
  tournament_live_status_paused_hint: "Pausiert — kein Push",
  settings_live_publish_log_title: "Push-Verlauf",
  settings_live_publish_log_empty: "Noch kein Push protokolliert.",
  settings_live_publish_log_clear: "Verlauf leeren",
  settings_live_publish_log_show_all: "Alle anzeigen",
  settings_live_publish_log_collapse: "Einklappen",
  settings_live_publish_log_reason_event: "Aenderung",
  settings_live_publish_log_reason_heartbeat: "Heartbeat",
  settings_live_publish_log_reason_manual: "Manuell",
  settings_live_publish_log_reason_final: "Final",
  tournament_unpublish: "Live-Veroeffentlichung beenden",
  tournament_unpublish_confirm: "Turnier von der Webseite entfernen? Der Endstand verschwindet von der Live-Seite. Diese Aktion betrifft nur die Webseite, nicht das Turnier in BOSS.",
  tournament_unpublish_done: "Live-Eintrag entfernt",
  tournament_unpublish_failed: "Konnte nicht entfernt werden: {error}",
  ...
  tournament_view_tab_groups: "Gruppen",
  ...
  management_remove_confirm_title: "Spieler entfernen?",
  management_remove_confirm_message: "{name} wird aus diesem Turnier entfernt.",
  management_remove_confirm_hint: "Der Spieler bleibt in der Stammdaten-Liste und kann später wieder hinzugefuegt werden.",
  management_remove_confirm_action: "Entfernen",
  ...
  print_window_blocked: "Druckfenster wurde blockiert. Bitte stattdessen 'Als PDF speichern' verwenden.",
  ...
  tv_phase_group: "Gruppenphase",
  tv_phase_ko: "KO-Phase",
  tv_phase_completed: "Beendet",
  tv_groups_strip_header: "Gruppen",
  ...
  tournament_view_undo_round_title: "Runde rueckgaengig machen?",
  tournament_view_undo_target_label: "Folgende Runde wird geloescht:",
  tournament_view_undo_match_count: "{n} Matches",
  tournament_view_undo_completed_count: "{n} abgeschlossen",
  tournament_view_undo_set_count: "{n} Saetze eingetragen",
  tournament_view_undo_active_count: "{n} Match auf einem Feld",
  tournament_view_undo_phase_to_group: "Das Turnier wechselt zurueck in die Gruppenphase.",
  tournament_view_undo_phase_to_draft: "Das Turnier wird auf Entwurf zurueckgesetzt.",
  tournament_view_undo_confirm: "Rueckgaengig machen",
  tournament_view_undo_done: "Runde \"{label}\" rueckgaengig gemacht ({matches} Matches, {sets} Saetze)",
