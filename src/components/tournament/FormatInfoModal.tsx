...
export default function FormatInfoModal({
  ...
  return (
    ...
    >
      <div
        className={`${theme.cardBg} rounded-2xl shadow-2xl w-full max-w-lg max-h-[85vh] overflow-y-auto p-6 border ${theme.cardBorder} mx-4`}
      ...
      >
        ...
        <div className="flex items-start justify-between mb-4">
          ...
          <button
            onClick={onClose}
            className={`${theme.textMuted} hover:${theme.textPrimary} transition-colors text-xl leading-none ml-4 mt-0.5`}
